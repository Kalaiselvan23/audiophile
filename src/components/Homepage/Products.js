...
export default function Products() {
  return (
    <div className=" flex w-[70%] mx-auto justify-around h-fit mt-32 ">
      <div className="product-categ">
        ...
        <span className="flex text-xs text-[#95774A] mt-2">SHOP<img src={Arrow} alt="" className="right-arrow"/></span>
      </div>
      <div className="product-categ">
        <img
